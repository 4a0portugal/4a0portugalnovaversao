...
const RAW_DATABASE = [
  ...
  },
  {
    ...
    "jogadores": [
      { "nome": "Vítor Baía", "posicoes": ["GR"], "ovr": 90 },
  ...
  },
  {
    ...
    "jogadores": [
      { "nome": "Diogo Costa", "posicoes": ["GR"], "ovr": 89 },
  ...
  },
  {
    ...
    "jogadores": [
      { "nome": "Vítor Baía", "posicoes": ["GR"], "ovr": 92 },
      { "nome": "Diogo Costa", "posicoes": ["GR"], "ovr": 89 },
      { "nome": "João Pinto", "posicoes": ["DD"], "ovr": 88 },
      { "nome": "Paulo Ferreira", "posicoes": ["DD"], "ovr": 85 },
      { "nome": "Ricardo Carvalho", "posicoes": ["DC"], "ovr": 93 },
      { "nome": "Pepe", "posicoes": ["DC"], "ovr": 92 },
      { "nome": "Aloísio", "posicoes": ["DC"], "ovr": 85 },
      { "nome": "Jorge Costa", "posicoes": ["DC"], "ovr": 88 },
      { "nome": "Branco", "posicoes": ["DE"], "ovr": 87 },
      { "nome": "Alex Sandro", "posicoes": ["DE"], "ovr": 86 },
      { "nome": "Deco", "posicoes": ["MC"], "ovr": 95 },
      { "nome": "Lucho González", "posicoes": ["MC"], "ovr": 87 },
      { "nome": "Maniche", "posicoes": ["MC"], "ovr": 86 },
      { "nome": "Vitinha", "posicoes": ["MC"], "ovr": 86 },
      { "nome": "Costinha", "posicoes": ["MC"], "ovr": 85 },
      { "nome": "James Rodriguez", "posicoes": ["MC", "EXE"], "ovr": 90 },
      { "nome": "Paulo Futre", "posicoes": ["EXE", "EXD"], "ovr": 94 },
      { "nome": "Rabah Madjer", "posicoes": ["EXD", "PL"], "ovr": 90 },
      { "nome": "Hulk", "posicoes": ["EXD"], "ovr": 91 },
      { "nome": "Luis Díaz", "posicoes": ["EXE"], "ovr": 88 },
      { "nome": "Radamel Falcao", "posicoes": ["PL"], "ovr": 93 },
      { "nome": "Mário Jardel", "posicoes": ["PL"], "ovr": 92 },
      { "nome": "Fernando Gomes", "posicoes": ["PL"], "ovr": 92 }
    ]
  },
...
// ==========================================
  ...
  // ==========================================
  {
    ...
    "jogadores": [
      ...
      { "nome": "Fernando Cruz", "posicoes": ["DE", "DC"], "ovr": 83 },
      { "nome": "Mário Coluna", "posicoes": ["MC"], "ovr": 92 },
      { "nome": "José Neto", "posicoes": ["MC"], "ovr": 78 },
      { "nome": "Joaquim Santana", "posicoes": ["MC"], "ovr": 82 },
      { "nome": "Cavém", "posicoes": ["MC", "DE"], "ovr": 84 },
      { "nome": "Fernando Calado", "posicoes": ["MC"], "ovr": 73 },
      { "nome": "Inácio Esperança", "posicoes": ["MC"], "ovr": 74 },
      { "nome": "António Simões", "posicoes": ["EXE"], "ovr": 87 },
      { "nome": "José Augusto", "posicoes": ["EXD"], "ovr": 85 },
      { "nome": "Mendes", "posicoes": ["EXD", "EXE"], "ovr": 72 },
      { "nome": "Eusébio", "posicoes": ["PL", "EXE", "EXD"], "ovr": 96 },
      { "nome": "José Águas", "posicoes": ["PL"], "ovr": 90 },
      { "nome": "José Augusto Torres", "posicoes": ["PL"], "ovr": 83 },
  ...
  },
  {
    ...
    "jogadores": [
      ...
      { "nome": "Adolfo Calisto", "posicoes": ["DE"], "ovr": 83 },
      { "nome": "Humberto Coelho", "posicoes": ["DC"], "ovr": 90 },
      { "nome": "Messias Timula", "posicoes": ["DC"], "ovr": 84 },
  ...
  },
  {
    ...
    "jogadores": [
      { "nome": "Jan Oblak", "posicoes": ["GR"], "ovr": 88 },
  ...
  },
  {
    ...
    "jogadores": [
      ...
      { "nome": "Rúben Dias", "posicoes": ["DC"], "ovr": 84 },
      ...
      { "nome": "Pizzi", "posicoes": ["EXD", "MC"], "ovr": 86 },
      ...
      { "nome": "Rafa Silva", "posicoes": ["EXE", "EXD"], "ovr": 86 },
      ...
      { "nome": "João Félix", "posicoes": ["PL", "MC"], "ovr": 87 },
      { "nome": "Haris Seferović", "posicoes": ["PL"], "ovr": 79 },
      { "nome": "Jonas", "posicoes": ["PL"], "ovr": 81 },
  ...
  },
  {
    ...
    "jogadores": [
      { "nome": "Manuel Bento", "posicoes": ["GR"], "ovr": 90 },
      { "nome": "Costa Pereira", "posicoes": ["GR"], "ovr": 88 },
      { "nome": "Miguel Monteiro", "posicoes": ["DD"], "ovr": 85 },
      { "nome": "Maxi Pereira", "posicoes": ["DD"], "ovr": 82 },
      { "nome": "Humberto Coelho", "posicoes": ["DC"], "ovr": 92 },
      { "nome": "Carlos Mozer", "posicoes": ["DC"], "ovr": 88 },
      { "nome": "Luisão", "posicoes": ["DC"], "ovr": 87 },
      { "nome": "Ezequiel Garay", "posicoes": ["DC"], "ovr": 88 },
      { "nome": "Alex Grimaldo", "posicoes": ["DE"], "ovr": 85 },
      { "nome": "Fábio Coentrão", "posicoes": ["DE"], "ovr": 86 },
      { "nome": "Mário Coluna", "posicoes": ["MC"], "ovr": 94 },
      { "nome": "Rui Costa", "posicoes": ["MC"], "ovr": 92 },
      { "nome": "Pablo Aimar", "posicoes": ["MC"], "ovr": 89 },
      { "nome": "Petit", "posicoes": ["MC"], "ovr": 85 },
      { "nome": "Enzo Pérez", "posicoes": ["MC"], "ovr": 85 },
      { "nome": "Ángel Di María", "posicoes": ["EXD"], "ovr": 90 },
      { "nome": "Simão Sabrosa", "posicoes": ["EXE"], "ovr": 87 },
      { "nome": "Nicolás Gaitán", "posicoes": ["EXE", "EXD"], "ovr": 86 },
      { "nome": "Chalana", "posicoes": ["EXE"], "ovr": 91 },
      { "nome": "Eusébio", "posicoes": ["PL"], "ovr": 97 },
      { "nome": "Jonas", "posicoes": ["PL"], "ovr": 88 },
...
// ==========================================
  ...
  // ==========================================
  {
    ...
    "jogadores": [
      { "nome": "João Azevedo", "posicoes": ["GR"], "ovr": 87 },
      { "nome": "Dores", "posicoes": ["GR"], "ovr": 71 },
      { "nome": "Octávio Barrosa", "posicoes": ["DC"], "ovr": 86 },
      { "nome": "Manuel Marques", "posicoes": ["DC"], "ovr": 85 },
      { "nome": "Juvenal", "posicoes": ["DC", "DD"], "ovr": 82 },
      { "nome": "Cardoso", "posicoes": ["DC"], "ovr": 74 },
      { "nome": "Veríssimo", "posicoes": ["DE"], "ovr": 79 },
      { "nome": "Canário", "posicoes": ["MC"], "ovr": 83 },
      ...
      { "nome": "Albano", "posicoes": ["EXE"], "ovr": 89 },
      { "nome": "José Travassos", "posicoes": ["MC", "EXD", "EXE"], "ovr": 91 },
      { "nome": "Manuel Vasques", "posicoes": ["MC", "PL"], "ovr": 90 },
  ...
  },
  {
    ...
    "jogadores": [
      { "nome": "Joaquim Carvalho", "posicoes": ["GR"], "ovr": 83 },
      { "nome": "Aníbal", "posicoes": ["GR"], "ovr": 70 },
      { "nome": "Pedro Gomes", "posicoes": ["DD"], "ovr": 82 },
      { "nome": "Hilário", "posicoes": ["DE"], "ovr": 86 },
      { "nome": "Alexandre Baptista", "posicoes": ["DC"], "ovr": 82 },
      { "nome": "José Carlos", "posicoes": ["DC", "MC"], "ovr": 83 },
      { "nome": "João Morais", "posicoes": ["DC", "MC", "DD"], "ovr": 83 },
      { "nome": "Fernando Mendes", "posicoes": ["MC"], "ovr": 85 },
      ...
      { "nome": "Mascarenhas", "posicoes": ["PL"], "ovr": 86 },
      { "nome": "Ernesto Figueiredo", "posicoes": ["PL"], "ovr": 83 },
  ...
  },
  {
    ...
    "jogadores": [
      ...
      { "nome": "Carlos Alhinho", "posicoes": ["DC"], "ovr": 84 },
  ...
  },
  {
    ...
    "jogadores": [
      ...
      { "nome": "Duscher", "posicoes": ["MC"], "ovr": 82 },
      { "nome": "Pedro Barbosa", "posicoes": ["MC", "EXD", "EXE"], "ovr": 83 },
      { "nome": "Bino", "posicoes": ["MC"], "ovr": 73 },
      ...
      { "nome": "Alberto Acosta", "posicoes": ["PL"], "ovr": 85 },
  ...
  },
  {
    ...
    "jogadores": [
      { "nome": "Antonio Adán", "posicoes": ["GR"], "ovr": 82 },
      { "nome": "Luís Maximiano", "posicoes": ["GR"], "ovr": 74 },
      { "nome": "Pedro Porro", "posicoes": ["DD", "EXD"], "ovr": 85 },
      { "nome": "Sebastián Coates", "posicoes": ["DC"], "ovr": 86 },
      ...
      { "nome": "Nuno Mendes", "posicoes": ["DE", "EXE"], "ovr": 85 },
      ...
      { "nome": "Pedro Gonçalves", "posicoes": ["EXD", "EXE", "MC"], "ovr": 86 },
      { "nome": "Nuno Santos", "posicoes": ["EXE", "DE"], "ovr": 81 },
      { "nome": "Jovane Cabral", "posicoes": ["EXE", "EXD"], "ovr": 75 },
      { "nome": "Tabata", "posicoes": ["EXD", "MC"], "ovr": 74 },
      { "nome": "Tiago Tomás", "posicoes": ["PL"], "ovr": 72 },
      { "nome": "Paulinho", "posicoes": ["PL"], "ovr": 80 },
  ...
  },
  {
    ...
    "jogadores": [
      ...
      { "nome": "Viktor Gyökeres", "posicoes": ["PL"], "ovr": 89 },
  ...
  },
  {
    ...
    "jogadores": [
      ...
      { "nome": "Geovany Quenda", "posicoes": ["EXD", "DD"], "ovr": 80 },
      { "nome": "Geny Catamo", "posicoes": ["DD", "DE", "EXD"], "ovr": 81 },
      { "nome": "Gonçalo Inácio", "posicoes": ["DC"], "ovr": 85 },
      { "nome": "Ousmane Diomande", "posicoes": ["DC"], "ovr": 86 },
      { "nome": "Zeno Debast", "posicoes": ["DC"], "ovr": 78 },
      { "nome": "Eduardo Quaresma", "posicoes": ["DC"], "ovr": 76 },
      { "nome": "Matheus Reis", "posicoes": ["DE", "DC"], "ovr": 75 },
      { "nome": "Maxi Araújo", "posicoes": ["DE", "EXE"], "ovr": 86 },
      { "nome": "Morten Hjulmand", "posicoes": ["MC"], "ovr": 87 },
      { "nome": "Hidemasa Morita", "posicoes": ["MC"], "ovr": 82 },
      { "nome": "Daniel Bragança", "posicoes": ["MC"], "ovr": 79 },
      { "nome": "Pedro Gonçalves", "posicoes": ["EXE", "MC", "EXD"], "ovr": 84 },
      { "nome": "Trincão", "posicoes": ["EXD", "EXE"], "ovr": 87 },
      { "nome": "Nuno Santos", "posicoes": ["DE", "EXE"], "ovr": 78 },
  ...
  },
  {
    ...
    "jogadores": [
      { "nome": "Vítor Damas", "posicoes": ["GR"], "ovr": 89 },
      { "nome": "Peter Schmeichel", "posicoes": ["GR"], "ovr": 90 },
      { "nome": "Pedro Porro", "posicoes": ["DD"], "ovr": 86 },
      { "nome": "Hilário", "posicoes": ["DE"], "ovr": 88 },
      { "nome": "Sebastián Coates", "posicoes": ["DC"], "ovr": 88 },
      { "nome": "André Cruz", "posicoes": ["DC"], "ovr": 86 },
      { "nome": "Eurico Gomes", "posicoes": ["DC"], "ovr": 85 },
      { "nome": "Gonçalo Inácio", "posicoes": ["DC"], "ovr": 85 },
      ...
      { "nome": "José Travassos", "posicoes": ["MC"], "ovr": 92 },
...
// ==========================================
  ...
  // ==========================================
  {
    ...
    "jogadores": [
      { "nome": "José Capela", "posicoes": ["GR"], "ovr": 84 },
      { "nome": "Feliciano", "posicoes": ["DC"], "ovr": 83 },
      { "nome": "Serafim Neves", "posicoes": ["DC"], "ovr": 80 },
      { "nome": "Vasco", "posicoes": ["DD"], "ovr": 76 },
      { "nome": "Mariano Amaro", "posicoes": ["MC"], "ovr": 85 },
      { "nome": "Feliciano Loureiro", "posicoes": ["MC"], "ovr": 78 },
      { "nome": "Gomes", "posicoes": ["MC"], "ovr": 74 },
      { "nome": "Mário Gomes", "posicoes": ["MC"], "ovr": 73 },
      { "nome": "Artur Quaresma", "posicoes": ["EXD"], "ovr": 86 },
      { "nome": "José Pedro", "posicoes": ["EXE"], "ovr": 83 },
      { "nome": "Rafael Correia", "posicoes": ["PL", "MC"], "ovr": 87 },
      { "nome": "Manuel Andrade", "posicoes": ["PL"], "ovr": 85 },
  ...
  },
  {
    ...
    "jogadores": [
      { "nome": "Ricardo", "posicoes": ["GR"], "ovr": 84 },
      ...
      { "nome": "Petit", "posicoes": ["MC"], "ovr": 84 },
      { "nome": "Erwin Sánchez", "posicoes": ["MC"], "ovr": 83 },
      ...
      { "nome": "Elpídio Silva", "posicoes": ["PL"], "ovr": 83 },
  ...
  },
  {
    ...
    "jogadores": [
      { "nome": "Matheus", "posicoes": ["GR"], "ovr": 81 },
      ...
      { "nome": "Al Musrati", "posicoes": ["MC"], "ovr": 82 },
      ...
      { "nome": "Ricardo Horta", "posicoes": ["EXD", "EXE", "MC"], "ovr": 84 },
      { "nome": "Iuri Medeiros", "posicoes": ["EXD"], "ovr": 77 },
      { "nome": "Bruma", "posicoes": ["EXE", "EXD"], "ovr": 82 },
      { "nome": "Álvaro Djaló", "posicoes": ["EXE", "EXD"], "ovr": 75 },
      { "nome": "Simon Banza", "posicoes": ["PL"], "ovr": 81 },
  ...
  },
  {
    ...
    "jogadores": [
      ...
      { "nome": "Ademir", "posicoes": ["MC"], "ovr": 82 },
      ...
      { "nome": "Cascavel", "posicoes": ["PL"], "ovr": 84 },
  ...
  },
  {
    ...
    "jogadores": [
      { "nome": "Douglas Jesus", "posicoes": ["GR"], "ovr": 80 },
      { "nome": "Assis", "posicoes": ["GR"], "ovr": 69 },
      { "nome": "Ricardo Pereira", "posicoes": ["DD", "EXD", "DE"], "ovr": 80 },
      { "nome": "Alex", "posicoes": ["DD"], "ovr": 74 },
      { "nome": "Paulo Oliveira", "posicoes": ["DC"], "ovr": 79 },
      ...
      { "nome": "André André", "posicoes": ["MC"], "ovr": 78 },
      ...
      { "nome": "Soudani", "posicoes": ["EXE", "PL"], "ovr": 80 },
  ...
  },
  {
    ...
    "jogadores": [
      ...
      { "nome": "Bernard Mensah", "posicoes": ["MC"], "ovr": 76 },
      { "nome": "Hurtado", "posicoes": ["MC"], "ovr": 76 },
      { "nome": "Tozé", "posicoes": ["MC"], "ovr": 74 },
      { "nome": "Raphinha", "posicoes": ["EXD", "EXE"], "ovr": 81 },
      { "nome": "Hernâni", "posicoes": ["EXD"], "ovr": 77 },
      { "nome": "Sturgeon", "posicoes": ["EXE"], "ovr": 74 },
...
// ==========================================
  ...
  },
  {
    ...
    "jogadores": [
      ...
      { "nome": "Ricardo", "posicoes": ["GR"], "ovr": 74 },
      { "nome": "João Dias", "posicoes": ["DD"], "ovr": 72 },
      { "nome": "Cedric Soares", "posicoes": ["DD"], "ovr": 78 },
      ...
      { "nome": "Adrien Silva", "posicoes": ["MC"], "ovr": 80 },
  ...
  },
  {
    ...
    "jogadores": [
      { "nome": "Cássio", "posicoes": ["GR"], "ovr": 80 },
      ...
      { "nome": "André Leão", "posicoes": ["MC"], "ovr": 77 },
      { "nome": "Luiz Carlos", "posicoes": ["MC"], "ovr": 78 },
      { "nome": "Josué", "posicoes": ["MC", "EXD", "EXE"], "ovr": 80 },
  ...
  {
    "id": "set_2008",
    "nomeEquipa": "Vitória Setúbal 2008",
    "jogadores": [
      { "nome": "Eduardo", "posicoes": ["GR"], "ovr": 82 },
      { "nome": "Janício", "posicoes": ["DD"], "ovr": 75 },
      { "nome": "Auri", "posicoes": ["DC"], "ovr": 75 },
      { "nome": "Robson", "posicoes": ["DC"], "ovr": 76 },
      { "nome": "Jorginho", "posicoes": ["DE"], "ovr": 74 },
      { "nome": "Sandro", "posicoes": ["MC"], "ovr": 78 },
      { "nome": "Ricardo Chaves", "posicoes": ["MC"], "ovr": 77 },
      { "nome": "Leandro Lima", "posicoes": ["MC", "EXE"], "ovr": 78 },
      { "nome": "Bruno Ribeiro", "posicoes": ["MC", "EXE"], "ovr": 74 },
      { "nome": "Cláudio Pitbull", "posicoes": ["PL", "EXD"], "ovr": 81 },
      { "nome": "Matheus", "posicoes": ["PL", "EXD"], "ovr": 76 }
    ]
  },
  {
    "id": "vsc_2025",
    "nomeEquipa": "Vitória SC 2025",
    "jogadores": [
      { "nome": "Bruno Varela", "posicoes": ["GR"], "ovr": 78 },
      { "nome": "Bruno Gaspar", "posicoes": ["DD"], "ovr": 76 },
      { "nome": "Alberto Costa", "posicoes": ["DD"], "ovr": 78 },
      { "nome": "Jorge Fernandes", "posicoes": ["DC"], "ovr": 76 },
      { "nome": "Toni Borevković", "posicoes": ["DC"], "ovr": 76 },
      { "nome": "Tomás Ribeiro", "posicoes": ["DC"], "ovr": 75 },
      { "nome": "Ricardo Mangas", "posicoes": ["DE", "EXE"], "ovr": 77 },
      { "nome": "Tomás Händel", "posicoes": ["MC"], "ovr": 82 },
      { "nome": "Tiago Silva", "posicoes": ["MC"], "ovr": 82 },
      { "nome": "Samu", "posicoes": ["MC"], "ovr": 78 },
      { "nome": "Kaio César", "posicoes": ["EXD"], "ovr": 80 },
      { "nome": "Jota Silva", "posicoes": ["EXE", "PL"], "ovr": 83 },
      { "nome": "Nélson Oliveira", "posicoes": ["PL"], "ovr": 76 },
      { "nome": "Jesús Ramírez", "posicoes": ["PL"], "ovr": 75 }
    ]
  },
  {
    "id": "mor_2017",
    "nomeEquipa": "Moreirense 2017",
    "jogadores": [
      { "nome": "Makaridze", "posicoes": ["GR"], "ovr": 81 },
      { "nome": "Sagna", "posicoes": ["DD"], "ovr": 77 },
      { "nome": "Iago Santos", "posicoes": ["DC"], "ovr": 77 },
      { "nome": "Diego Galo", "posicoes": ["DC"], "ovr": 76 },
      { "nome": "Rebocho", "posicoes": ["DE"], "ovr": 78 },
      { "nome": "Cauê", "posicoes": ["MC"], "ovr": 79 },
      { "nome": "Fernando Neto", "posicoes": ["MC"], "ovr": 75 },
      { "nome": "Francisco Geraldes", "posicoes": ["MC"], "ovr": 79 },
      { "nome": "Nildo Petrolina", "posicoes": ["MC", "EXE"], "ovr": 78 },
      { "nome": "Daniel Podence", "posicoes": ["EXD", "EXE"], "ovr": 82 },
      { "nome": "Ousmane Dramé", "posicoes": ["EXD"], "ovr": 78 },
      { "nome": "Emmanuel Boateng", "posicoes": ["PL"], "ovr": 80 }
    ]
  },
  {
    "id": "tor_2026",
    ...
    "jogadores": [
      ...
      { "nome": "Stopira", "posicoes": ["DC"], "ovr": 76 },
